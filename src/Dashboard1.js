    ...
    return (
        <div className="dash">
          ...
          <header className="header">
            <h1 className="header__heading"><a href="https://github.com/AbubakerSaeed/dashboard-ui-n20" target="_blank" rel="noreferrer noopener">DI</a></h1>
          ...
          <div className="body">
            ...
            <main className="main">
              ...
              <div className="main__col-1">
                {/* HEADING */}
                <div>
                  <h2 className="main__heading"><span style={{background: 'linear-gradient(to bottom, hsl(247, 88%, 70%), hsl(282, 82%, 51%))', boxShadow: '0 2px 12px hsla(247, 88%, 70%, .3)'}}>
                ...
                <ul className="main__list">
                  ...
                  <li className="main__list-item">
                    <div className="main__list-content-wrap">
                      <p className="main__list-content">Masmak Fortress</p>
                      <p className="main__list-sub">My Favorite</p>
                    </div>
                  </li>
                  <li className="main__list-item">
                    <div className="main__list-item-image">
                    ...
                    <div className="main__list-content-wrap">
                      <p className="main__list-content">Wadi Namar Waterfall</p>
                      <p className="main__list-sub">Relaxing</p>
                    </div>
                  </li>
                  <li className="main__list-item">
                    <div className="main__list-content-wrap">
                      <p className="main__list-content">Wadi Hanifah</p>
                      <p className="main__list-sub">At Last</p>
                    </div>
                  </li>
                  <li className="main__list-item">
                    <div className="main__list-content-wrap">
                      <p className="main__list-content">Heet Cave</p>
