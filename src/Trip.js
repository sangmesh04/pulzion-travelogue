...
<div className="row">
 ...
 <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
   <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
     ...
     <button type="button" className="btn mx-2 btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#arrangeTrip">
   ...
   <div className="row">
	...
	<div className="course">
		<div className="course-preview">
			<h6>Organizer</h6>
			<h3>Siddarth Singh</h3>
			<Link to="tripdetail">view details <i className="fas fa-chevron-right"></i></Link>
		</div>
		<div className="course-info">
            <h3>Maharashtra Day Celebration</h3><br />
			<h6>1st May 2022</h6>
			<h4>Sinhgad Fort</h4>
		</div>
    ...
    <i class="bi bi-images"></i>
       ...
       {/* <!-- arrange trip --> */}
<div className="modal fade" id="arrangeTrip" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div className="modal-dialog">
  <form action="#">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="staticBackdropLabel">Arrange Trip</h5>
...
<strong>  Congratulation!  </strong>Trip arranged!
  <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      ...
      <br />
      <div className="form-floating">
      <input type="text" className="form-control" required id="source" placeholder="source" />
      <label htmlFor="floatingsource">Starting Point</label>
      </div>
      <br />
      <div className="form-floating">
      <input type="datetime-local" className="form-control" required id="date" placeholder="Date N Time" />
      <label htmlFor="floatingdate">Estimated Date & Time</label>
      </div>
        
      </div>
      <div className="modal-footer">
        <button type="button" className="btn btn-dark" data-bs-dismiss="modal">Cancel</button>
        <button type="submit" id='signupbtn' className="btn btn-primary">Finish</button>
      </div>
    </div>
    </form>
  </div>
